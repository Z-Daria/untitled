...
export const orderButtons = `<div class="order"><img class="move-up" src="https://img.icons8.com/material-outlined/24/000000/collapse-arrow.png"/>
<img class="move-down" src="https://img.icons8.com/material-outlined/24/000000/expand-arrow.png"/></div>`;
export const editButton = `<div class="edit">
...
export const deleteButton = `<div class="delete">
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="24" height="24"
                    viewBox="0 0 172 172"
                    ...
                    $(document).ready(() => {
                        ...
                        console.log($('.name').html('<span>bla</span>'));
